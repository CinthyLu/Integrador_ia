...
```
Esto ocurría porque el script de PowerShell ejecutaba internamente la instrucción `python -m venv $environmentPath`, requiriendo de forma estricta la instalación de la versión de Python 3.11. El entorno del desarrollador disponía únicamente de Python 3.12 y Python 3.14.
